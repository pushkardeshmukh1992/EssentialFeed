...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedView_hasTitle() {
        ...
        let localizedTitle = bundle.localizedString(forKey: localisedKey, value: nil, table: "Feed")
        
        XCTAssertNotEqual(localisedKey, localizedTitle, "Missing localised string for key : \(localisedKey)")
    ...
    func test_loadFeedCompletion_rendersSuccessfullyLoadedFeed() {
        ...
        let image2 = makeImage(description: "a descreption", location: nil)
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
        ...
        XCTAssertEqual(view1?.renderedImage, .none, "Expect no image state change for second view once first image loading completes successfully")

        let imageData1 = UIImage.make(withColor: .blue).pngData()!
        loader.completeImageLoading(with: imageData1, at: 1)
        XCTAssertEqual(view0?.renderedImage, imageData0, "Expected no image state change for first view second image loading completes successfully")
    ...
    func test_feedImageViewRetryButton_isVisibleOnInvalidImageData() {
        ...
        XCTAssertEqual(view0?.isShowingRetryAction, false, "Expected no retry action while loading the image")
    ...
    private func makeImage(description: String? = nil, location: String? = nil, url: URL = URL(string: "http://anyur.com")!) -> FeedImage {
